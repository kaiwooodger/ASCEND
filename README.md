...
Release record: [docs/RELEASE_1.8.4.md](docs/RELEASE_1.8.4.md).

Version 1.8.4 adds an explicit PDF table for the Layer 3.1B vertex, valley, and remaining-tumour decomposition, including regional mean surviving fractions, tumour-volume fractions, and residual-survivor contributions. Version 1.8.3 added case reset and explicit per-OAR EUD and mean-surviving-fraction reporting. Version 1.8.2 introduced provenance-bound manual tumour alpha/beta overrides, explicit manual or RTPLAN-control-point delivery-time selection, RSS 2020 Table 2 C1/C2 and N1-N3 parameter reproduction, separately sourced 2022 C3 values, and resilient page-splittable PDF histogram reporting. Layer execution continues to require current DVH-verified Layer 1 masks. Layer 3 remains research software and is not clinically validated.
